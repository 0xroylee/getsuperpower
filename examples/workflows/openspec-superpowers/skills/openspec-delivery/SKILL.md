...
# OpenSpec Delivery Omniskill Workflow

This is the entry skill for the openspec-delivery Omniskill workflow.
...
- This skill orchestrates through required instructions; Omniskill installs and validates the dependency skills.
