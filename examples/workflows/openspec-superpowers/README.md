...
This example turns an OpenSpec delivery loop into an installable Omniskill workflow
...
This Omniskill workflow combines local OpenSpec handoff guidance with reusable agent
skills:
