# Proposal: Document Omniskill Authoring Guideline

## Summary

Make the authoring path obvious for people who want to create their own
Omniskill workflow and skills set. The guide should tell authors to call the
...
- Changing the Omniskill manifest schema.
