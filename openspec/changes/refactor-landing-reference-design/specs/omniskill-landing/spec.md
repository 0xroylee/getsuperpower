# Omniskill Landing Reference Refactor Spec
...
- **THEN** the document identifies
  `/Users/roy/Downloads/Create Omniskill Workflows/` as the current
  reference source
...
- **THEN** the page still presents Omniskill as a workflow-bundle product
