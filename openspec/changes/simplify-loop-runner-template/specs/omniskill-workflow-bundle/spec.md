# Omniskill Workflow Bundle Spec

## MODIFIED Requirements

### Requirement: Looped Workflow Install Prepares Entry Skill Runtime Files

Omniskill SHALL prepare looped entry skill installs by copying dynamic
...
- **THEN** Omniskill validates that the script path is a relative in-bundle
  `.mjs` output path
...
- **WHEN** Omniskill writes `loop.metadata.json`
