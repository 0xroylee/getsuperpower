...
GetSuperpower marketing surface without changing the root Bun CLI package
runtime.
...
### Requirement: Landing Page Presents GetSuperpower Workflow Bundles

The landing page SHALL present GetSuperpower as a workflow-bundle product for
AI-agent skill trees.

#### Scenario: visitor reads the first screen

- **WHEN** a visitor opens the landing page
- **THEN** GetSuperpower is visible as the primary product signal
...
The landing page SHALL teach the current root-first GetSuperpower command
surface.
...
- **AND** the page does not advertise removed nested `getsuperpower`
...
- **THEN** it includes attribution to the original "Create GetSuperpower
