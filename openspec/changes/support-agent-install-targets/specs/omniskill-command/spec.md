# Omniskill Agent Install Target Spec
...
- **WHEN** a user runs
  `omniskill skills install pony-trail --agents claude,codex,cursor,opencode,copilot`
...
- **WHEN** a user runs
  `omniskill skills install pony-trail --agents opencodex`
...
- **WHEN** a user runs
  `omniskill skills install pony-trail --agents github-copilot`
...
- **WHEN** a user runs
  `omniskill skills update pony-trail --agents claude,codex,cursor,opencode,copilot`
...
- **WHEN** a user runs `omniskill skills install pony-trail --agents unknown-agent`
