# omniskill-landing Specification

## Purpose

Define the public Omniskill landing page behavior for explaining workflow
...
- **AND** the demo does not read generated `.omniskill/` state
